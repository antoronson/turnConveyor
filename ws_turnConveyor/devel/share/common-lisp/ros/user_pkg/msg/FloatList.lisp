...
(cl:defmethod cl:initialize-instance :after ((m <FloatList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FloatList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name user_pkg-msg:<FloatList> is deprecated: use user_pkg-msg:FloatList instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <FloatList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader user_pkg-msg:data-val is deprecated.  Use user_pkg-msg:data instead.")
  (data m))
