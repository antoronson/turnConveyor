...
(cl:defmethod cl:initialize-instance :after ((m <FloatList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FloatList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msg-msg:<FloatList> is deprecated: use custom_msg-msg:FloatList instead.")))
